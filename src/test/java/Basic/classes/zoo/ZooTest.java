...
import Basic.classes.zoo.Animal;
import Basic.classes.zoo.Zoo;
...
class ZooTest {
    ...
    @Test
    void shouldReturnCorrectResultGetNameByTheLargestCount() {
        ...
        String result = Zoo.getNameByTheLargestCountOfAnimalsByZoo(zoos);
        String expected = "Zoo3";
        Assertions.assertEquals(expected,result);
    }

    @Test
    void shouldReturnCorrectResultGetNameByTheLargestCountWithEmptyInputArray() {
        Zoo[] zoos = {};
        String result = Zoo.getNameByTheLargestCountOfAnimalsByZoo(zoos);
        String expected = "";
        Assertions.assertEquals(expected,result);
    ...
    @Test
    void shouldReturnCorrectResultGetAverageTicketPriceInZoos() {
        Animal animal1 = new Animal("Кот", "cat");
        Animal animal2 = new Animal("Собака", "dog");
        Animal animal3 = new Animal("Хомяк", "hamster");
        Animal animal4 = new Animal("Попугай", "parrot");
    ...
    @Test
    void shouldReturnCorrectResultGetAverageTicketPriceInZoosWithEmptyInputArray() {
        Zoo[] zoos = {};
        double result = Zoo.getAverageTicketPriceInZoos(zoos);
        double expected = 0;
        Assertions.assertEquals(expected,result);
